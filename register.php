  ...
  <style>
      body{
        ...
        background-size: auto;
         background-position:unset;background: rgb(12,0,36);
...
<!------------------------------- form ------------------------- -->
    ...
    <button  style="border-radius: 0.6rem; " id="back" ><a href="index.php">HOME</a></button>
    <!-- <h3 id="fam">JOIN OUR FAMILY OF CARS!</h3> -->
     <!-- <h4>Resgister Here</h4> -->
 <div class="main"> 
        ...
        <form id="register" action="register.php" method="POST">    
            ...
            <label id="label-names">Password : </label>
            <!-- <br> -->
            ...
            <!-- <br><br> -->
            <label id="label-names">Confirm Password : </label>
            <!-- <br> -->
            <input type="password" name="cpass" 
            id="cpsw" placeholder="Renter the password" required>
            <!-- <br><br> -->
            <tr id="table-of-mf">
                <td><label id="label-names">Gender : </label></td><br>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<td>
                    <label id="label-names" for="one">Male</label>
                    <input type="radio" id="input_enabled" name="gender" value="male" style="width:200px">
                </td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  
                <td>
                    <label id="label-names" for="two">Female</label>
                    <input type="radio" id="input_disabled" name="gender" value="female" style="width:160px" />
                </td>
            </tr>
            <!-- <br><br> -->

            <input type="submit" class="btnn"  value="REGISTER" name="regs" style="background-color: #fff;color: black">
