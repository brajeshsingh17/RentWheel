...
<body  background="images/booking7.jpg">
<style>
*{
    margin: 0;
    padding: 0;
       ...
       <div class="hai">
            ...
            <h1>ReN<span>t</span> Wheel<span>s</span></h1>
                ...
                <div class="menu" >
                    ...
                    <li><p style="color: orange;" class="phello">HELLO! &nbsp;<a id="pname"><?php echo $rows['FNAME']." ".$rows['LNAME']?></a></p></li>
        ...
        <form id="register" method="POST">
            ...
            <label id="form-ke-labels">BOOKING PLACE : </label>
            <br>
            <input type="text" name="place"
            id="name" placeholder="Enter Your Destination">
            <br><br>

            <label  id="form-ke-labels">BOOKING DATE : </label>
            <br>
            <input type ="date" name="date"
            id="datefield" min='1899-01-01' max='2000-13-13'  placeholder="ENTER THE DATE FOR BOOKING">
            <br><br>

            <label  id="form-ke-labels">DURATION : </label>
            <br>
            <input type ="number" name="dur" min="1" max="30" 
            id="name" placeholder="Enter Rent Period (in days)">
            <br><br>

            <label  id="form-ke-labels">PHONE NUMBER : </label>
            <br>
            <input type="tel" name="ph" maxlength="10"
            id="name" class='inputPhone' placeholder="Enter Your Phone Number" >
            <br><br>
            
            <label  id="form-ke-labels">DESTINATION : </label>
            <br>
            <input type="text" name="des"
            id="name" placeholder="Enter Your Destination"> 
            <br><br> 

            <label  id="form-ke-labels">RETURN DATE : </label>
            <br>
